...
| 5 | Client `.docx` engine | Implement the client-side TypeScript engine in `packages/docx-engine` against `docx-template-contract.md`; render the **PSR**. | sprint_0002 contract | Critical | ADR-0001 D22 |
